        ...
        <form id="formularioEditar" class="container">
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select class="custom-select" id="auxFacturacionEdit" name="auxFacturacionEdit" disabled="disabled">
                  <option selected>Seleccionar...</option>
                  <?php foreach( $listarAuxFacturacion as $item ): ?>
