...
//Listar
	public function listar() {
		...
		$sentencia = $this->ejecutar("SELECT encargo.*, sub.nombre AS estado, CONCAT(usAuxiliarFacturacion.nombre, '  ', usAuxiliarFacturacion.apellido) AS auxiliarFacturacion, CONCAT(usVerif.nombre, '  ', usVerif.apellido) AS verificador
		FROM encargos AS encargo
		INNER JOIN subitem AS sub ON sub.id = encargo.estado
		INNER JOIN usuarios AS usAuxiliarFacturacion ON usAuxiliarFacturacion.id = encargo.idAuxiliarFacturacion
